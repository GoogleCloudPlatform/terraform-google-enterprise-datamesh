...
| cloudbuildv2\_repo\_id | Custom CloudBuildv2 repository ID. Format: 'projects/PROJECT\_ID/locations/LOCATION/repositories/REPO\_ID'. | `string` | `""` | no |
...
| tf\_repo\_uri | The URI of the repo where Terraform configs are stored. | `string` | `null` | no |
...
| cloudbuild\_sa\_email | SA email used by Cloud Build triggers |
