...
// sb-d-shared-restricted-us-central1
data "google_compute_subnetwork" "subnetwork" {
  name    = "sb-${data.google_project.project.labels.env_code}-shared-${data.google_project.project.labels.vpc}-${var.region}"
  region  = var.region
  project = var.restricted_host_project_id
}
