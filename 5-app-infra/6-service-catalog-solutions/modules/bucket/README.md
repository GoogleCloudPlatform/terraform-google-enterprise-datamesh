...
| <a name="input_logging_bucket_name"></a> [logging\_bucket\_name](#input\_logging\_bucket\_name) | Name prefix to be used for GCS Bucket | `string` | `"bkt-prj-c-logging-x0gn-org-logs-f0gv"` | no |
| <a name="input_name"></a> [name](#input\_name) | Name of the bucket; Prefix prj-<environment\_code>- is added automatically | `string` | n/a | yes |
...
| logging\_bucket\_name | Name prefix to be used for GCS Bucket | `string` | `"LOGGING_BUCKET_NAME"` | no |
| name | Name of the bucket; Prefix prj-<environment\_code>- is added automatically | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| name | Generated unique name fort the bucket |
