...
############### Internal processing methods ###############
    ...
    def dataset_exists(self, bigquery_project, bigquery_dataset):
        ...
        try:
            ...
            print(f"Dataset {bigquery_dataset} exists in project {bigquery_project}.")
            return True
        except NotFound:
            # Dataset not found
            print(f"Dataset {bigquery_dataset} not found in project {bigquery_project}.")
            return False
    ...
    def history_table_exists(self, table_name):
        ...
        print("Attempting to get dataset reference for project {} and dataset {}".format(bigquery_project, bigquery_dataset))
        dataset_id = DatasetReference(project=bigquery_project, dataset_id=bigquery_dataset)
...
if __name__ == '__main__':
    ...
    target_service_account = os.getenv('TAG_CREATOR_SA', config['DEFAULT']['TAG_CREATOR_SA'].strip())
