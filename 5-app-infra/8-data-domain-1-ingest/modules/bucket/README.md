...
| Name | Description | Type | Default | Required |
|------|-------------|------|---------|:--------:|
| business\_code | Business code. | `string` | n/a | yes |
| domain\_name | Data domain name. | `string` | n/a | yes |
| dual\_region\_locations | dual region description | `list(string)` | `[]` | no |
| environment | Environment. | `string` | n/a | yes |
| environment\_code | Environment code. | `string` | n/a | yes |
...
| log\_bucket\_name | Logging bucket name | `string` | n/a | yes |
| name | name of buckßet | `string` | n/a | yes |
